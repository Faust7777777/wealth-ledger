// Android 真机/AVD 触摸复验（2026-07-28 P0）：与同名 widget 测试同一路径，
// 但跑在真实设备的输入与渲染管线上，用来复验"点会话标题真的切换会话"。
// 运行：flutter test integration_test/agent_session_menu_touch_test.dart -d <device>
