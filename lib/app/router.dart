  ...
  routes: [
    StatefulShellRoute.indexedStack(
      ...
      branches: [
        StatefulShellBranch(
          routes: [
            GoRoute(path: '/overview', builder: (c, s) => const OverviewPage()),
          ],
        ),
        StatefulShellBranch(
          routes: [
            GoRoute(path: '/accounts', builder: (c, s) => const AccountsPage()),
          ],
        ),
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/investment',
              builder: (c, s) => const InvestmentPage(),
            ),
          ],
        ),
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: '/liabilities',
              builder: (c, s) => const LiabilitiesPage(),
            ),
          ],
        ),
      ],
    ...
    GoRoute(
      path: '/record/manual',
      builder: (c, s) => const ManualRecordPage(),
    ),
    ...
    GoRoute(
      path: '/movement/:id',
      builder: (c, s) =>
          MovementDetailPage(movementId: s.pathParameters['id']!),
    ),
    GoRoute(
      path: '/dev/tokens',
      builder: (c, s) => const _TokensPreviewRoute(),
    ),
  ],
);
